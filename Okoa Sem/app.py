...
st.title("Okoa sem na Lyzr")
st.markdown("### Welcome to the Okoa semester!")
st.markdown("Okoa sem na Lyzr will provide you 10 insightful questions on the textbook pdf you have uploaded")
...
os.environ["OPENAI_API_KEY"] = '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'
